  ...
  async (req, res) => {
    ...
    try {
      ...
      const newNotificationObject = {
        message: `Notification from ${user.name}`,
      ...
      //   const usersNotifications = usersCollection[i]
      //   usersNotifications.notificationMessage.unshift(newNotificationObject)
      //   await usersNotifications.save()
      //   console.log('4')
      // }
      console.log('--------clling here-----------------------------------')
      req.io.sockets.emit('notification', { newNotificationObject })

      // Saving the notifications on user messages
